...
const Hero = () => {
  return (
    ...
    <section id="home" className="min-h-[90vh] flex flex-col items-center justify-center text-center px-4 bg-transparent transition-colors duration-300">
      
      <div className="relative z-10 flex flex-col items-center">
        <div className="mb-8 flex justify-center items-center">
         
          <div className="profile-border-container w-52 h-52 md:w-60 md:h-60 shadow-xl overflow-hidden rounded-full border-4 border-blue-600/20 dark:border-cyan-500/30 transition-colors duration-300">
            <img 
              src={heroImg} 
              alt="Thant Zin Oo"
      ...
      <h1 className="text-3xl md:text-5xl font-bold mb-4 tracking-tight text-gray-900 dark:text-white">
        THANT ZIN OO | <span className="text-blue-600 dark:text-cyan-400 text-[0.8em]">Digital Portfolio</span>
      </h1>
      ...
      <div className="mt-10 flex flex-wrap justify-center gap-4">
        ...
        {/* Get in Touch Button */}
        <a href="#contact">
          <button className="bg-gray-900 dark:bg-white text-white dark:text-gray-900 px-8 py-3 rounded-full font-semibold transition-all hover:opacity-90 active:scale-95 shadow-md">
            Get in Touch
          </button>
        </a>
      </div>
