...
const Projects = () => {
  ...
  const categories = ['All', 'Web Design', 'React & Firebase', 'Next.js','Python Django','MERN Stack'];
  ...
  return (
    <section id="projects" className="py-20 px-6 bg-gray-50 dark:bg-gray-950">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-4xl font-bold text-center mb-10 underline decoration-blue-500 underline-offset-8 dark:text-white">
          My Projects
        </h2>
  ...
  className="w-full h-48 object-cover"
        ...
        {filteredProjects.length === 0 && (
          <div className="text-center text-gray-500 mt-10">
            ဒီ Category မှာ ပရောဂျက် မရှိသေးပါဘူးဗျ။
          </div>
        )}
      </div>
    </section>
